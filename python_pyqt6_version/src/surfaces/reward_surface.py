...
class RewardSurface():
    ...
    def work_show_button_function(self):
        ...
        elif self.task_class == 'photo':
            button_function.photo_work_show_button(self.app, self.main_window, self.main_frame,
                                                   self.task_class, self.task_level,
                                                   self.title_task_text, self.work_contents_label,
                                                   self.work_date_label)
        elif self.task_class == 'video':
            button_function.video_work_show_button(self.app, self.main_window, self.main_frame,
                                                   self.task_class, self.task_level,
                                                   self.title_task_text, self.work_contents_label,
                                                   self.work_date_label)
        elif self.task_class == 'audio':
            button_function.audio_work_show_button(self.app, self.main_window, self.main_frame)

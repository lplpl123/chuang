...
class VideoSurface():
    def __init__(self, app, main_window, main_frame, task_item):
        ...
        self.video_main_frame.show()
        # init function tools
        self.databasefunction = databaseFunction()

    def _setup_main_frame(self):
        self.video_main_frame = QFrame(self.main_window)
        self.video_main_frame.setGeometry(0, 0, 800, 640)
        self.video_main_frame.raise_()

    def _setup_frames(self):
        # frames
        self.title_frame = QFrame(self.video_main_frame)
        self.title_frame.setStyleSheet("background-color: black;")
        self.work_frame = QFrame(self.video_main_frame)
        self.work_frame.setStyleSheet("background-color: black;")
        # layout
        self.tol_vertical_layout = QVBoxLayout(self.video_main_frame)
    ...
    def _setup_title_frame_widgets(self):
        ...
        self.title_task_level.setStyleSheet("""
                                            QWidget{
                                            image:url(./resources/title_frame_imgs/level_""" + self.task_level + """_video.png)
                                            }
                                            """)
        # title_task_text
        ...
        self.title_exit_button.setStyleSheet("""
                                            ...
                                            image:url(./resources/title_frame_imgs/exit_video.png);
                                            border: none;
                                            }

                                            QPushButton::hover{
                                            image:url(./resources/title_frame_imgs/exit_hover_video.png);
    ...
    def _setup_work_frame_widgets(self):
        ...
        background_gif = QMovie("./resources/title_frame_imgs/film.gif")
        background_gif.setScaledSize(QSize(80, 80))
    ...
    def work_done_button_function(self):
        button_function.work_done_button(self.app, self.main_window, self.main_frame,
                                         self.video_main_frame, self.task_class,
